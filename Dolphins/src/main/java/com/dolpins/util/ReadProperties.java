package com.dolpins.util;

import com.dolpins.util.PropertyPlaceholderHelper;
import com.dolpins.util.PropertyPlaceholderHelper.PropertyPlaceholderConfigurerResolver;
import com.dolpins.typemapping.DatabaseTypeUtils;
...
public class ReadProperties {
    ...
    static final String PROPERTIES_FILE_NAMES[] = new String[]{"database.properties", "database.xml"};
