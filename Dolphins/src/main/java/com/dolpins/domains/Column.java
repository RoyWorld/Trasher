package com.dolpins.domains;


import com.dolpins.domains.ColumnHelper;
import com.dolpins.tools.GLogger;
import com.dolpins.util.ReadProperties;
import com.dolpins.tools.StringHelper;
import com.dolpins.typemapping.ActionScriptDataTypesUtils;
import com.dolpins.typemapping.DatabaseDataTypesUtils;
import com.dolpins.typemapping.JavaPrimitiveTypeMapping;
import com.dolpins.typemapping.JdbcType;
...
//	}
	...
	public List<EnumMetaDada> getEnumList() {
		return ColumnHelper.string2EnumMetaData(getEnumString());
	}
...
//			_table.getExportedKeys().addForeignKey(refTable.getSqlName(), hasMany.columnSqlName, getSqlName(), hasMany.columnSqlName.toLowerCase().hashCode());
	...
	private void initOtherProperties() {
		...
		javaType = ReadProperties.getProperty("java_typemapping."+normalJdbcJavaType,normalJdbcJavaType).trim();
